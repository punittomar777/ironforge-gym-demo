  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="grid h-9 w-9 place-items-center bg-accent text-white transition-transform duration-200 group-hover:-rotate-6">
          ...
          {navLinks.map((link) => (
            <li key={link.href}>
              <a
                ...
                className="block border-b border-border/60 py-4 font-display text-lg font-medium uppercase tracking-wide text-foreground"
              >
                {link.label}
              </a>
            </li>
